  ...
  return (
    <footer className="border-t border-vapor dark:border-vapor/30 px-6 py-12 lg:px-12" role="contentinfo">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 sm:flex-row sm:items-start sm:justify-between">
        {/* Brand */}
        <div>
          <Link href="/" className="font-serif text-lg italic text-ink dark:text-ink transition-colors hover:text-graphite dark:hover:text-graphite">
            The Archives
          </Link>
        ...
        <nav className="flex flex-wrap justify-center gap-x-8 gap-y-2 sm:justify-end" aria-label="Footer navigation">
          ...
          <Link href="/duo" className="font-mono text-[10px] uppercase tracking-widest-custom text-graphite transition-colors hover:text-ink dark:hover:text-ink-secondary">
            Duo
          </Link>
          <Link href="/gallery" className="font-mono text-[10px] uppercase tracking-widest-custom text-graphite transition-colors hover:text-ink dark:hover:text-ink-secondary">
            Gallery
          </Link>
        </nav>
      </div>
      ...
      {/* Bottom bar */}
      <div className="mx-auto mt-8 flex max-w-5xl items-center justify-between border-t border-vapor dark:border-vapor/30 pt-6">
