    ...
    <section className="relative min-h-screen py-24 lg:py-section" aria-label="Character selection">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {characters.map((char, i) => (
          <div
            key={char.name}
            className="absolute inset-x-0 mx-auto sm:inset-x-auto sm:mx-0 sm:right-[3vw] lg:right-[5%] top-[48%] sm:top-[20%] w-[95vw] sm:w-[50vw] lg:w-[45vw] max-w-[650px] h-[48%] sm:h-[65%] transition-all duration-700 ease-out"
            style={{
